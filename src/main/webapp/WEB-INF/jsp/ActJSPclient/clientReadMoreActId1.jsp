...
<!--         </a> -->
  ...
  <div class="wrapper">
    <div class="page-header page-header-small">
      <div class="page-header-image" data-parallax="true" style="background-image: url('${pageContext.request.contextPath}/img/ActImg/img1.jpg');">
      </div>
      <div class="content-center">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto text-center">
            <h2 class="title">毛孩運動會 - 汪汪障礙賽小型犬</h2>
            <h4>2022年7月7日至10日台中國際展覽館</h4>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="button-container">
              ...
              <a href="https://www.facebook.com/sharer.php?u＝http://dinerocom.eastasia.cloudapp.azure.com/dinero/activities/activity.readmore/1" class="btn btn-icon btn-lg btn-facebook btn-round">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-8 ml-auto mr-auto">
              <h3 class="title">一個專屬於毛小孩的運動會</h3>
              <p>人狗同心其力斷金，什麼障礙都無法阻攔你們！<br><br>
                 跑跑跳跳玩耍趣，與寵寶貝的歡樂時光，是培養默契的最好時刻，特別規劃主題障礙趣味競賽，設計多項障礙設施供毛爸媽與毛孩一同玩樂，參與比賽即可獲得知名品牌參賽好禮，每場次前兩名得主更可獲得知名品牌精美大禮喔，各場次活動名額有限，額滿即截止報名，趕緊參加不要錯過！號外號外！<br><br>
                 每場次前三名還加碼進棚拍攝免費寵物專業寫真唷。
              <br />
              <br /> </p>
        ...
        <div class="container">
          <div class="section-story-overview">
            <div class="row justify-content-center">
              <div class="col-md-6">
                <div class="image-container image-center" style="background-image: url('${pageContext.request.contextPath}/img/ActImg/img1-1.jpg')">           
                </div>
              </div>
              <!-- <div class="col-md-5"> -->
          ...
          <div class="row justify-content-center">
            <div class="col-md-6 ml-auto mr-auto text-center">
              ...
              <ul class="nav nav-pills nav-pills-primary justify-content-center" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" data-toggle="" href="${pageContext.request.contextPath}/activities/activity.enroll/1" role="tablist">
                    點我報名
                  </a>
                </li>
                <li class="nav-item">
